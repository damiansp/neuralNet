...
class NeuralNetwork(object):
    def __init__(self, input_nodes, hidden_nodes, output_nodes, learning_rate):
        ...
        #### TODO: Set self.activation_function to your implemented sigmoid
        # function ####
        #
    ...
    def forward_pass_train(self, X):
        ...
        hidden_inputs = self.weights_input_to_hidden * X 
    ...
    def backpropagation(self,
        ...
        hidden_error_term = (
            np.dot(output_error_term, self.weights_hidden_to_output) *
            hidden_ouputs * (1 - hidden_outputs))
    ...
    def run(self, features):
        ...
        hidden_inputs = self.weights_input_to_hidden * features
